...
function NavButtonProfile({ openModalRegister, openModalLogin, isLogin, IsLoggedout }) {
    return (
        <>
            <div className="z-20 pl-10 my-auto">
                {isLogin ? (
                    <div className="relative flex group hover:cursor-pointer">
                        ...
                        <div className="dropdown-menu w-[200px] absolute right-0 mt-5 pt-4 max-h-0 opacity-0 transform -translate-y-5 transition-all duration-500 ease-in-out overflow-hidden group-hover:max-h-96 group-hover:opacity-100 group-hover:translate-y-0">
