...
function Page() {
  ...
  const handleCategoryClick = (category) => {
    ...
    sessionStorage.setItem("category", category); // Save selected category to sessionStorage
  };

  const filteredBootcamps = items.filter((item) => {
    return (
      selectedCategory === "All" || // Adjust logic for filtering
  ...
  const getButtonClass = (category) => {
    return selectedCategory === category
      ? "cursor-pointer text-[#14a7a0] bg-gray-100/50 rounded-lg p-2 mb-4"
      : "flex items-center gap-1 cursor-pointer text-[#3a3f47] p-2 mb-4";
  };
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="w-full h-52 sm:h-80 md:h-[450px] rounded-xl relative z-10 overflow-hidden">
          <Image
            ...
            width={500}
            height={500}
            className="w-full h-[200px] sm:h-80 md:h-[500px] rounded-xl"
            alt="bootcamp"
          />
        </div>
        <div className="w-full mt-5 sm:mt-10">
          <h3 className="text-xl md:text-2xl font-medium text-[#3a3f47]">
            Bootcamp Program Options
          </h3>
          <p className="text-xs md:text-sm font-light text-[#3a3f47]">
            Choose and become a professional!
          </p>
        </div>

        <div className="flex md:flex-row flex-col py-10 md:py-20 justify-end md:justify-between">
          <div className="w-1/5 hidden md:block">
            <div className="text-xl font-medium text-[#3a3f47] mb-6">
              Filter Bootcamp
            </div>
              ...
              {[
                ...
                >
                  {category === "Web Development" && (
                    <AiOutlineGlobal className="size-7" />
                  )}
                  {category === "Data Science" && (
                    <GiMaterialsScience className="size-7" />
                  )}
                  {category === "Machine Learning" && (
                    <LuBrainCircuit className="size-7" />
                  )}
                  {category === "AI Academy" && (
                    <FaMicrochip className="size-7" />
                  )}
          ...
          <form className="mx-auto w-full block md:hidden">
            <label
              htmlFor="countries"
              className="block mb-2 text-sm font-medium text-gray-90 capitalize"
            >
                        ...
                        <div>
                          <div className="flex items-center gap-1 mb-2">
                            ...
                            <svg
                              ...
                              className="svg-inline--fa fa-circle-check h-3 text-green-500"
                              role="img"
                          ...
                          <div className="flex flex-wrap">
                            <div className="flex items-center gap-1 mb-2  text-slate-500 w-1/2">
                              <svg
                                ...
                                className="svg-inline--fa fa-chart-column fa-fw h-3"
                                role="img"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512"
                              >
                            ...
                            <div className="flex items-center gap-1 mb-2  text-slate-500 w-1/2">
                              <svg
                                ...
                                data-prefix="fas"
                                data-icon="clock"
                                className="svg-inline--fa fa-clock h-3 "
                                role="img"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512"
                              >
                            ...
                            <div className="flex items-center gap-1 mb-2  text-slate-500 w-1/2">
                              <svg
                                ...
                                data-prefix="fas"
                                data-icon="users"
                                className="svg-inline--fa fa-users h-3"
                                role="img"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 640 512"
                              >
                            ...
                            <div className="flex items-center gap-1 mb-2  text-slate-500 w-1/2">
                              <svg
                                ...
                                className="svg-inline--fa fa-swatchbook h-3"
                                role="img"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512"
                              >
                        ...
                        <div className="flex items-center">
                          <div className="text-orange-500 flex items-center">
                            <svg
                              ...
                              className="inline fa-star-half-stroke me-1 h-4"
                              role="img"
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 576 512"
                            >
                          ...
                          <span className="ms-1 text-[#3a3f47]">
                            <small>({item.totalRating}) Evaluation</small>
                          </span>
                        </div>
                      </div>
                      <div className="w-full">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td className="text-right text-xs">
                                  Rp. <span>{item.buy}</span>
                                </td>
                              </tr>
                              <tr>
                                <td className="text-left text-xs">Rent</td>
                                <td className="text-right text-xs">
                                  Rp. <span>{item.rent}</span>
                                </td>
                              </tr>
                            </tbody>
                          </table>
