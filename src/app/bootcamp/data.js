export const bootcampData = [
  {
    ...
    description:
      "Learn how to build modern websites using the latest technologies.",
    rating: 4.95,
    ...
    modul: [
      {
        ...
        moduleDescription:
          "This module will cover the basics of web development and setting up your environment.",
        videos: 11,
        readings: 12,
        assignments: 3,
      },
      ...
      },
      {
        ...
        moduleDescription:
          "This module will introduce JavaScript, its syntax, and its usage.",
        videos: 7,
        readings: 3,
        assignments: 1,
      },
  ...
  },
  {
    ...
    description:
      "Gain skills in data analysis and visualization using top tools.",
    rating: 4.95,
    ...
    modul: [
      {
        ...
        moduleDescription:
          "Learn the foundations of data science and the tools used in the field.",
        videos: 10,
        readings: 8,
        assignments: 2,
      },
      {
        ...
        moduleDescription:
          "This module will teach you data analysis using Python.",
        videos: 12,
        readings: 10,
        assignments: 3,
      },
      {
        ...
        moduleDescription:
          "Learn how to effectively visualize data using various tools.",
        videos: 8,
        readings: 6,
        assignments: 1,
      },
  ...
  },
  {
    ...
    modul: [
      ...
      },
      {
        ...
        moduleDescription:
          "Deep dive into supervised learning algorithms and techniques.",
        videos: 12,
        readings: 8,
        assignments: 3,
      },
      {
        ...
        moduleDescription:
          "Explore unsupervised learning methods and clustering techniques.",
        videos: 9,
        readings: 7,
        assignments: 1,
      },
    ...
    modul: [
      {
        ...
        moduleDescription:
          "Get started with mobile app development fundamentals.",
        videos: 10,
        readings: 5,
        assignments: 2,
      },
  ...
  },
  {
    ...
    category: "Web Development",
    description:
      "Panduan langkah demi langkah untuk belajar Typescript Restful API.",
    rating: 4.95,
    teacher: "John Doe",
    level: "Medium",
    time: "5 hours",
    ...
    modul: [
      ...
      },
      {
        ...
        moduleDescription:
          "Discover how to create RESTful APIs using TypeScript.",
        videos: 11,
        readings: 6,
        assignments: 3,
      },
      {
        ...
        moduleDescription:
          "Learn testing and deployment strategies for your APIs.",
        videos: 9,
        readings: 4,
        assignments: 1,
      },
  ...
  },
  {
    ...
    category: "Web Development",
    description:
      "Learn to build scalable server-side applications using Node.js.",
    rating: 4.8,
    ...
    jobPresenter: "Back-End Engineer",
    descPresenter:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin malesuada urna at arcu volutpat, eu facilisis massa dignissim.",
    benefits: [
  ...
  },
  {
    ...
    descPresenter:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean vel erat non felis dictum cursus.",
    benefits: [
    ...
    modul: [
      ...
      },
      {
        ...
        moduleDescription:
          "Explore advanced concepts like closures and asynchronous programming.",
        videos: 10,
        readings: 5,
        assignments: 2,
      },
  ...
  },
  {
    ...
    descPresenter:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque volutpat justo ac erat tristique, non hendrerit enim condimentum.",
    benefits: [
    ...
    modul: [
      ...
      },
      {
        ...
        moduleDescription:
          "Learn about neural networks and deep learning techniques.",
        videos: 10,
        readings: 7,
        assignments: 2,
      },
      {
        ...
        moduleDescription:
          "Understand techniques for optimizing machine learning models.",
        videos: 9,
        readings: 6,
        assignments: 1,
      },
  ...
  },
  {
    ...
    category: "AI Academy",
    description:
      "Learn the principles of artificial intelligence and how to create intelligent applications.",
    rating: 4.9,
    teacher: "Ari Widodo",
    level: "Medium",
    time: "7 hours",
    ...
    descPresenter:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer convallis elit id nisi bibendum, eu dignissim nulla aliquam.",
    benefits: [
    ...
    modul: [
      ...
      },
      {
        ...
        moduleDescription:
          "Explore various applications of AI in the industry.",
        videos: 9,
        readings: 6,
        assignments: 1,
      },
  ...
  },
  {
    ...
    jobPresenter: "Front-End Developer",
    descPresenter:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vel augue nec velit fringilla auctor.",
    benefits: [
    ...
    modul: [
      {
        ...
        moduleDescription:
          "Learn the fundamentals of CSS and how to apply styles.",
        videos: 8,
        readings: 4,
        assignments: 1,
      },
      {
        ...
        moduleDescription:
          "Understand the box model and how to use it effectively.",
        videos: 10,
        readings: 5,
        assignments: 2,
      },
