...
function Join() {
    return (
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
            <div className="w-full p-8 text-center border rounded-lg shadow sm:p-8 backdrop-blur-sm bg-white/20">
                <h5 className="mb-2 text-xl md:text-3xl font-bold text-[#3a3f47]">What are you waiting for?</h5>
                <div className="w-3/5 mx-auto">
                    <p className="mb-10 text-sm md:text-base sm:text-sm text-[#3a3f47]">Learn more focused by attending classes and meet ups</p>
                </div>
