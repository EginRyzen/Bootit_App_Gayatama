    ...
    return (
        <div className="relative overflow-hidden">
            <div className="absolute inset-0 -z-10">
                <div className="absolute bottom-auto left-auto right-0 top-0 h-[400px] w-[400px] -translate-x-[30%] translate-y-[20%] rounded-full bg-[rgba(95,164,242,0.5)] opacity-50 blur-[80px]"></div>
                <div className="absolute bottom-auto left-auto right-0 top-0 h-[400px] w-[400px] translate-x-[10%] translate-y-[50%] rounded-full bg-[rgba(95,164,242,0.5)] opacity-50 blur-[80px]"></div>
                <div className="absolute bottom-auto left-0 top-0 h-[400px] w-[400px] translate-x-[10%] translate-y-[20%] rounded-full bg-[rgba(95,164,242,0.5)] opacity-50 blur-[80px]"></div>
            </div>
