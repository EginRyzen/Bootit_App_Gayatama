...
function SlideCard({ settings, Slider, DataHome }) {
    return (
        <div className="max-w-6xl mx-auto overflow-hidden px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div className="slider-container">
                <Slider {...settings}>
                    {DataHome.CardKelas.map((item, index) => (
                        <a href='' key={index} className="px-2">
                            <div key={index} className="group max-w-sm mx-auto bg-white border border-gray-200 rounded-lg shadow">
                                <a href="#">
