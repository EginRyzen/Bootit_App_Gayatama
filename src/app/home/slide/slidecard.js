            ...
            <div className="slider-container">
                <Slider {...settings}>
                        ...
                        <div className="group max-w-sm mx-auto bg-white border border-gray-200 rounded-lg shadow">
                            ...
                            <div className="p-5">
                                ...
                                <div className="flex items-center mt-2">
                                    ...
                                    <span className="ms-1 text-[#3a3f47]"><small>(338) Penilaian</small></span>
                                </div>
                            </div>
                    ...
                    <div className="px-2">
                        <div className="max-w-sm mx-auto bg-white border border-gray-200 rounded-lg shadow">
                            <a href="#">
                                <img className="rounded-t-lg" src="https://image.web.id/images/Belajar-Cepat-Vue.jsa0b9a92b697c3564.png" />
                            </a>
                            <div className="p-5">
                                <div className="flex items-center gap-1">
                                    <span className="inline text-sm text-[#3a3f47]">
