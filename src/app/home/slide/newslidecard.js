...
function NewSlideCard({ bootcampData }) {
  ...
  return (
    <div className="max-w-6xl mx-auto relative overflow-hidden px-4 sm:px-6 lg:px-8 py-10">
      <div className="text-3xl mb-5 ml-2 font-semibold text-[#3a3f47]">
        Other Popular Class
      </div>
          ...
          {bootcampData.map((item, index) => (
            <SwiperSlide key={index}>
              <div
                ...
                className="max-w-sm min-h-[500px] mx-auto backdrop-blur-sm bg-white/50 rounded-lg shadow flex flex-col justify-between cursor-pointer"
              >
                <div>
                  <Image
                    width={450}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap">
                      <div className="flex items-center gap-1 mb-2  text-slate-500 w-1/2">
                        ...
                        <span className="inline text-sm">{item.level}</span>
                      </div>
                      <div className="flex items-center gap-1 mb-2  text-slate-500 w-1/2">
                        <svg
                          aria-hidden="true"
                        ...
                        <span className="inline text-sm">{item.time}</span>
                      </div>
                      <div className="flex items-center gap-1 mb-2  text-slate-500 w-1/2">
                        <svg
                          aria-hidden="true"
                        ...
                        <span className="inline text-sm">{item.students}</span>
                      </div>
                      <div className="flex items-center gap-1 mb-2  text-slate-500 w-1/2">
                        <svg
                          aria-hidden="true"
                        ...
                        <span className="inline text-sm">{item.module}</span>
                      </div>
                    </div>
                  </div>
