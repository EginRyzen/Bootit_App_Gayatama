...
export default function Intermediate() {
    ...
    const dataButton = [
        {
            id: 1,
            name: "Intermediate Android Development with Kotlin",
            button: 'Learn Android'
        },
        {
            id: 2,
            name: "iOS App Development: Advanced UI and Navigation",
            button: 'Learn iOS'
        },
        {
            id: 3,
            name: "Cross-Platform Mobile Development with React Native",
            button: 'Learn React Native'
        }
    ];
