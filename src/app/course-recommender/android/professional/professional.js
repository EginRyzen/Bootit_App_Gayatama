...
export default function Professional() {
    ...
    const dataButton = [
        {
            id: 1,
            name: "Advanced Android Architecture Patterns",
            button: 'Learn Android Architecture'
        },
        {
            id: 2,
            name: "Mastering iOS Performance Optimization",
            button: 'Learn iOS Optimization'
        },
        {
            id: 3,
            name: "Scaling and Deploying React Native Apps",
            button: 'Learn React Native Scaling'
        }
    ];
