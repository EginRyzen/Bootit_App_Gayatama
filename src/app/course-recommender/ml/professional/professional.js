...
export default function Professional() {
    ...
    const dataButton = [
        {
            id: 1,
            name: "Advanced Neural Networks and Architectures",
            button: 'Learn Neural Networks'
        },
        {
            id: 2,
            name: "Reinforcement Learning in Practice",
            button: 'Learn Reinforcement Learning'
        },
        {
            id: 3,
            name: "Model Deployment and Scalability",
            button: 'Learn Model Deployment'
        }
    ];
